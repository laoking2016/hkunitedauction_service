package com.hkunitedauction.console.configuration;
...
public class BaseSwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Console with Swagger2 is RESTful APIs").description("Console Service API")
